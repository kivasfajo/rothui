...
canvas.bg = t
local t = canvas:CreateTexture(nil, "BACKGROUND",nil,-7)
t:SetAllPoints(canvas)
t:SetTexture("Interface\\AddOns\\rPetBattleAnnouncer\\media\\canvasBgOverlay")
--t:SetBlendMode("ADD")
...
canvas.fight.bg = t
local t = fight:CreateTexture(nil, "BACKGROUND",nil,-4)
t:SetAllPoints(fight)
t:SetTexture("Interface\\AddOns\\rPetBattleAnnouncer\\media\\fight_hover")
t:SetBlendMode("ADD")
t:Hide()
canvas.fight.hover = t
...
fight:SetScript("OnMouseDown", function(...)
  ...
  --PlaySoundFile("Sound\\Creature\\Leviathan\\MON_Leviathan_AttackCrit_01.ogg")
  PlaySoundFile("Sound\\Creature\\Brutallus\\BrutallusLovingCombat01.ogg")
  canvas.ag2:Play()
end)
fight:SetScript("OnEnter", function(...)
  --PlaySound("igCreatureAggroSelect")
  PlaySoundFile("Sound\\Creature\\FelBeast\\FelBeastAggro.ogg")
  canvas.fight.hover:Show()
end)
fight:SetScript("OnLeave", function(...)
  --PlaySound("INTERFACESOUND_LOSTTARGETUNIT")
  canvas.fight.hover:Hide()
end)
...
canvas.exit.bg = t
local t = exit:CreateTexture(nil, "BACKGROUND",nil,-4)
t:SetAllPoints(exit)
t:SetTexture("Interface\\AddOns\\rPetBattleAnnouncer\\media\\exit_hover")
t:SetBlendMode("ADD")
t:SetVertexColor(1,0.4,0)
t:Hide()
canvas.exit.hover = t
...
exit:HookScript("OnMouseDown", function(...)
  --PlaySoundFile("Sound\\Creature\\BabyMurloc\\BabyMurlocB.wav")
  PlaySoundFile("Sound\\Creature\\FlameLeviathan\\UR_Leviathan_Overload02.ogg")
  canvas.ag2:Play()
end)
exit:SetScript("OnEnter", function(...)
  PlaySoundFile("Sound\\Creature\\BushChicken\\BushChicken_AttackCrit_03.ogg")
  --PlaySoundFile("Sound\\Creature\\BabyMurloc\\BabyMurlocA.wav")
  --PlaySound("igCreatureAggroSelect")
  canvas.exit.hover:Show()
end)
exit:SetScript("OnLeave", function(...)
  --PlaySound("INTERFACESOUND_LOSTTARGETUNIT")
  canvas.exit.hover:Hide()
end)
